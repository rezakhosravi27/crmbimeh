...
const LogoSliderMobile = () => {
    return (
        <div className="container">
            <div className="row mt-5 mb-5 d-md-none">
                <div className="col-sm-12">
                <Swiper className={styles.slider} slidesPerView={3} spaceBetween={0} slidesPerGroup={1} loop={true} loopFillGroupWithBlank={true} navigation={true} className="mySwiper">
...
export default LogoSliderMobile;